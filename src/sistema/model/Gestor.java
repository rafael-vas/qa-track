...
public class Feature extends Ticket {
    ...
    public Feature(int id, String titulo, String descricao, Usuario criador, Prioridade prioridade, String valorDeNegocio) {
    ...
    public String toString() {
        return super.toString() + " | Valor: " + valorDeNegocio;
    }
}
